...
const downloadTemplate = () => {
  ...
  const headers = [
    ["ID (не менять ID и порядок показателей!)", "Показатель", "Минимальное значение показателя", "Максимальное значение показателя", "Регион или название библиотеки"],
  ];
  ...
  const placeholderRow = [
    ...
    ["4", "Осадки", "Указать здесь значение показателя", "Указать здесь значение показателя", ""],
  ...
  return (
    <div className={style["form-container"]}>
      <h1 className={style["form-container__title"]}>Загрузить библиотеку</h1>
      ...
      <button className={style["form-container__saveButton"]}>Сохранить библиотеку</button>
    </div>
  );
};
